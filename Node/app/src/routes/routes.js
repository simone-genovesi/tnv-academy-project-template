...
import { createRanking, getRanking, getRankingByUserId, updateLastPoints } from "../controllers/rankings-controller.js"
...
router.patch(`${API_ROOT}/updateranking/:userId`, updateRating);
router.patch(`${API_ROOT}/lastpointranking/:userId`, updateLastPoints);
